                  ...
                  <div className="form">
                      ...
                      <div className="chair-selector">
                        {chairOptions.map((chair) => (
                          <button
                            ...
                            className={`chair-card ${formData.chairTpye === chair.id ? "chair-card--selected" : ""}`}
                          >
                            {chair.popular && (
                              <span className="chair-card__badge">
                                Most Popular
                              </span>
                            )}
                            ...
                            <p className="chair-card__description">
                              {chair.description}
                            </p>
                            <div className="chair-card__price">
                              KES {chair.price.toLocaleString()}{" "}
                              <span>per chair</span>
                            </div>
                          </button>
                        ))}
                    ...
                    {formData.chairTpye && (
                      <div className="form__group">
                        ...
                        />
                        <span className="form__hint">
                          Auto-filled based on {formData.guestCount} guests.
                          Adjust if needed.
                        </span>
                        ...
                        <div className="form__calculation">
                          ...
                          <span className="form__calculation-text">
                            Chair cost:{" "}
                            <strong>
                              KES {calculateChairCost().toLocaleString()}
                            </strong>
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="form__group">
                        <div className="form__info-box">
                          ...
                          <p className="form__info-box-text">
                            <strong>{tablesNeeded} dressed tables</strong> are
                            automatically included with your chair selection
                            (KES {PRICING.tables.dressed.toLocaleString()} per
                            table).
                          </p>
                          <div className="form__calculation">
                            <span className="form__calculation-icon">💰</span>
                            <span className="form__calculation-text">
                              Table cost:{" "}
                              <strong>
                                KES {calculateTableCost().toLocaleString()}
                              </strong>
                            </span>
                          </div>
                        </div>
                    ...
                    {formData.chairTpye && (
                      <div className="step__total">
                        <span className="step__total-label">
                          Seating & Tables Total:
                        </span>
                        <span className="step__total-amount">
                          KES{" "}
                          {(
                            calculateChairCost() + calculateTableCost()
                          ).toLocaleString()}
                        </span>
                      </div>
                    )}
