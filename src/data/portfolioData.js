import project1 from "../assets/images/portfolio/project1.jpg";
import project2 from "../assets/images/portfolio/project2.jpg";
import project3 from "../assets/images/portfolio/project3.jpg";
import project4 from "../assets/images/portfolio/project4.jpg";
import project5 from "../assets/images/portfolio/project5.jpg";
import project6 from "../assets/images/portfolio/project6.jpg";
import project7 from "../assets/images/portfolio/project7.jpg";
import project8 from "../assets/images/portfolio/project8.jpg";
import project9 from "../assets/images/portfolio/project9.jpg";
...
export const portfolioProjects = [
  {
    ...
    media: project1,
    eventType: "wedding",
    title: "Garden Romance at Marula Manor",
    description:
  ...
  },
  {
    ...
    media: project2,
    eventType: "birthday",
    title: "Champagne Dreams - 30th Birthday",
    description:
  ...
  },
  {
    ...
    title: "Sunset Terrace Celebration",
    description:
  ...
  },
  {
    ...
    title: "Princess Palace Transformation",
    description:
  ...
  },
  {
    ...
    title: "Honors Celebration Dinner",
    description:
  ...
  },
  {
    ...
    media: project1,
    eventType: "cooperate",
    title: "Annual Gala - Tech Company",
    description:
  ...
  },
  {
    ...
    media: project2,
    eventType: "birthday",
    title: "Tropical Escape in Nairobi",
    description:
...
export const allTags = [
  ...
  { id: "boho", label: "Boho", count: 2 },
  { id: "tropical", label: "Tropical", count: 1 },
  { id: "modern", label: "Modern", count: 1 },

  // Setting tags
  { id: "outdoor", label: "Outdoor", count: 3 },
  { id: "intimate", label: "Intimate", count: 3 },
  { id: "rooftop", label: "Rooftop", count: 1 },
  { id: "lakeside", label: "Lakeside", count: 1 },

  // Element tags
  { id: "florals", label: "Florals", count: 3 },
  { id: "balloons", label: "Balloons", count: 2 },
  { id: "lighting", label: "Lighting", count: 3 },
  { id: "metallics", label: "Metallics", count: 3 },

  // Feature tags
  { id: "interactive", label: "Interactive", count: 4 },
  { id: "custom-details", label: "Custom Details", count: 3 },
  { id: "instagram-worthy", label: "Instagram Worthy", count: 2 },
  { id: "quick-turnaround", label: "Quick Turnaround", count: 3 },

  // Special tags
  { id: "milestone", label: "Milestone", count: 2 },
  { id: "non-traditional", label: "Non-Traditional", count: 2 },
];