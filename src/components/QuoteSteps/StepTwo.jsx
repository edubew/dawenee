          ...
          <>
            <div className="form__group">
              ...
              <p className="form__hint" style={{ marginBottom: "1rem" }}>
                Complete your table setup with napkins, glasses, charger plates,
                and more
              </p>
                    ...
                    <div className="custom-settings__items">
                      ...
                      <label className="custom-setting-item">
                        <input
                          ...
                          onChange={() =>
                            handleCustomItemToggle("chargerPlates")
                          }
                        />
                        <div className="custom-setting-item__content">
                          <span className="custom-setting-item__name">
                    ...
                    <div className="custom-settings__items">
                      <label className="custom-setting-item">
                        <input
                          ...
                          onChange={() =>
                            handleCustomItemToggle("tableRunners")
                          }
                        />
                        <div className="custom-setting-item__content">
                          <span className="custom-setting-item__name">
                        ...
                        <div className="custom-setting-item__content">
                          ...
                          <span className="custom-setting-item__price">
                            ...
                            <strong>
                              ...
                              KES{" "}
                              {(
                                PRICING.tableSettingsPerTable
                                  .candlesAndHolders * tablesNeeded
                              ).toLocaleString()}
                            </strong>
                          </span>
                        </div>
            ...
            {settingsMode === "package" && (
              <div className="form__group">
                <div className="package-details">
                  <h4 className="package-details__title">
